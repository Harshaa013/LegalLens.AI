  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 animate-slide-down">
        ...
        {/* Tab Switcher */}
        <div className="flex p-1 bg-slate-200/80 backdrop-blur-sm rounded-xl self-center md:self-auto shadow-inner">
            <button
      ...
      {activeTab === 'analysis' ? (
        ...
        {/* Header Card */}
        <div 
            className="bg-white/80 backdrop-blur rounded-2xl shadow-sm border border-slate-200 p-6 md:p-8 animate-scale-in hover-lift"
            style={{ animationDelay: '100ms' }}
        >
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <div>
                <h1 className="text-2xl md:text-3xl font-bold text-slate-900 mb-2 tracking-tight">{contract.fileName}</h1>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button 
                        ...
                        className="flex items-center gap-1 text-indigo-600 hover:text-indigo-800 transition-all font-bold text-sm bg-indigo-50 hover:bg-indigo-100 px-3 py-1.5 rounded-full border border-indigo-100 shadow-sm hover:shadow-md ml-2"
            ...
            <div className="flex flex-col items-end">
                ...
                <div className="flex items-center gap-5">
                    ...
                    >
                        ...
                        <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wide mt-1">Risk Score</div>
                    ...
                    {typeof riskScore === 'number' && (
                    <div className="h-10 w-px bg-slate-200 animate-fade-in" style={{ animationDelay: '350ms' }}></div>
                    )}
            ...
            <div className="grid md:grid-cols-3 gap-8 border-t border-slate-100 pt-6">
            <div className="md:col-span-2 space-y-4">
                <h3 className="text-lg font-semibold text-slate-800 animate-fade-in" style={{ animationDelay: '500ms' }}>Executive Summary</h3>
                <div 
                    className="bg-white/50 hover:bg-white p-4 rounded-xl border border-transparent hover:border-slate-200 transition-all duration-300 hover:shadow-sm animate-slide-up group"
                    style={{ animationDelay: '600ms' }}
                >
                    <p className="text-slate-600 leading-relaxed text-justify group-hover:text-slate-800 transition-colors">
                    {summary}
                    </p>
                </div>
            </div>
            <div 
                className="bg-slate-50 rounded-xl p-4 flex flex-col items-center justify-center animate-scale-in border border-slate-100"
                style={{ animationDelay: '700ms' }}
            >
                <h4 className="text-sm font-semibold text-slate-500 mb-4">Risk Distribution</h4>
                ...
                <div className="flex gap-4 text-xs mt-2">
                    ...
                    <div key={d.name} className="flex items-center gap-1">
                        ...
                        <span className="text-slate-600">{d.value} {d.name}</span>
                    </div>
                    ))}
                </div>
            </div>
        ...
        <div>
            ...
            <h2 className="text-xl font-bold text-slate-900">Risk Analysis Details</h2>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 md:p-8 animate-fade-in">
            <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-slate-900">Document Text</h2>
            ...
            <div className="prose prose-slate max-w-none">
                {fullText ? (
                    <div className="whitespace-pre-wrap font-mono text-sm leading-relaxed text-slate-700 bg-slate-50 p-6 rounded-xl border border-slate-100 h-[70vh] overflow-y-auto">
                        {fullText}
                    </div>
                ) : (
